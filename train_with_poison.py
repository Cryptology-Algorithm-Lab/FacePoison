...
def main(args):
    ...
    # On-the-fly Poioson Generation    
    cfg.poison_module_dir = os.path.join(cfg.poison_module_dir, args.poison_name) + "/model_final.pt"
    
    poison_module = ResNetGenerator()
    poison_module.load_state_dict(torch.load(cfg.poison_module_dir, map_location = "cpu"))
    poison_module.eval().cuda()
    ...
    for epoch in range(start_epoch, cfg.num_epoch):
        ...
        for _, (img, local_labels) in enumerate(train_loader):
            ...
            local_embeddings = backbone(poisoned_img)
...
if __name__ == "__main__":
    ...
    parser.add_argument("poison_name", type=str, help="suffix")
